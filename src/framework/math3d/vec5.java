...
public class vec5{
    ...
    public vec5(Object... args){
        init(args);
    }
    
    private void init(Object[] args){
        int ctr=0;
        float[] _M = new float[5];
        for(Object a : args){
            if( a instanceof Number )
                ...
                throw new RuntimeException("Bad type for vec5 constructor");
        }
        
        if( ctr != 5 )
            throw new RuntimeException("Bad number of arguments for vec5 constructor");
    ...
    public float[] tofloats(){
        return new float[]{(float)x,(float)y,(float)z,(float)w,(float)v};
    }
    
    public float dot(vec5 o ){
        return x*o.x+y*o.y+z*o.z+w*o.w+v*o.v;
    }
    
    public vec5 add(vec5 o){
        return new vec5(x+o.x,y+o.y,z+o.z,w+o.w,v+o.v);
    }
    public vec5 sub(vec5 o){
        return new vec5(x-o.x,y-o.y,z-o.z,w-o.w,v-o.v);
    }
        
    public vec5 mul(double d){
        return new vec5(d*x,d*y,d*z,d*w,d*v);
    }
