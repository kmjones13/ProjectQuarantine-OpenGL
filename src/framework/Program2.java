...
public class Program2 {
    ...
    private static Program2 active;

    public Program2(String csfname) {
        init(null, null, null, null, null, csfname, new String[0]);
    }

    public Program2(String vsfname, String fsfname, String[] outputs) {
        init(vsfname, null, null, null, fsfname, null, outputs);
    }

    public Program2(String vsfname, String fsfname) {
        init(vsfname, null, null, null, fsfname, null, new String[]{"color"});
    }

    public Program2(String vsfname, String gsfname, String fsfname) {
        init(vsfname, null, null, gsfname, fsfname, null, new String[]{"color"});
    }

    public Program2(String vsfname, String tcsfname, String tesfname, String gsfname, String fsfname) {
        init(vsfname, tcsfname, tesfname, gsfname, fsfname, null, new String[]{"color"});
    }

    public Program2(String vsfname, String tcsfname, String tesfname, String gsfname, String fsfname, String[] outputs) {
    ...
    private void init(String vsfname, String tcsfname, String tesfname, String gsfname,
        ...
        for (int i = 0; i < numuniforms; ++i) {
            ...
            } else if (ty[0] == GL_UNSIGNED_INT_SAMPLER_2D && sz[0] == 1) {
                setter = new UISampler2DSetter(nm_, uloc, texcount++);
            } else if (ty[0] == GL_INT_VEC2 && sz[0] == 1) {
                setter = new IVec2Setter(nm_, uloc);
            } else {
    ...
    void setUniform(String name, Object value) {
        ...
        } else if (!warned_nonexistent.contains(name)) {
    ...
    class Mat4Setter extends UniformSetter {
        ...
        protected void set(Object o) {
            if (!(o instanceof mat4)) {
                throw new RuntimeException("Setting "+name+" to something that's not a mat4");
            }
    ...
    class Vec4Setter extends UniformSetter {
        ...
        public void set(Object o) {
            if (!(o instanceof vec4)) {
                throw new RuntimeException("Setting "+name+" to something that's not a vec4");
            }
            vec4 v = (vec4) o;
    ...
    class Sampler2DSetter extends UniformSetter {
        ...
        public void set(Object o) {
            if (!(o instanceof Texture2D)) {
                throw new RuntimeException("Setting "+name+" to something that's not a 2D texture");
            }
    ...
    class UISampler2DSetter extends UniformSetter {

        int unit;

        public UISampler2DSetter(String name, int idx, int unit) {
            super(name, idx);
            this.unit = unit;
        }
        ...
        @Override
        public void set(Object o) {
            if (!(o instanceof IntTexture)) {
                throw new RuntimeException("Setting "+name+" to something that's not an *integer* 2D texture");
            }
            Texture2D v = (Texture2D) o;
            v.bind(unit);
            glUniform1i(i, unit);
    ...
    class Vec3Setter extends UniformSetter {
        ...
        public void set(Object o) {
            if (!(o instanceof vec3)) {
                throw new RuntimeException("Setting "+name+" to something that's not a vec3");
            }
            vec3 v = (vec3) o;
    ...
    class Vec2Setter extends UniformSetter {
        ...
        public void set(Object o) {
            if (!(o instanceof vec2)) {
                throw new RuntimeException("Setting "+name+" to something that's not a vec2");
            }
            vec2 v = (vec2) o;
    ...
    class IVec2Setter extends UniformSetter {

        public IVec2Setter(String name, int idx) {
            super(name, idx);
        }
        ...
        public void set(Object o) {
            if (!(o instanceof ivec2)) {
                throw new RuntimeException("Setting "+name+" to something that's not an ivec2");
            }
            ivec2 v = (ivec2) o;
            glUniform2i(i, v.x, v.y);
        }
    }
    ...
    class FloatSetter extends UniformSetter {
        ...
        public void set(Object o) {
            if (!(o instanceof Number)) {
                throw new RuntimeException("Setting "+name+" to something that's not a numeric type");
            }
            Number n = (Number) o;
    ...
    class BooleanSetter extends UniformSetter {
        ...
        public void set(Object o) {
            if (!(o instanceof Boolean)) {
                throw new RuntimeException("Setting "+name+" to something that's not a boolean");
            }
            Boolean n = (Boolean) o;
            glUniform1i(i, n ? 1 : 0);
        }
    ...
    class SamplerCubeSetter extends UniformSetter {
        ...
        public void set(Object o) {
            if (!(o instanceof CubeTexture)) {
                throw new RuntimeException("Setting "+name+" to something that's not a cubemap");
            }
